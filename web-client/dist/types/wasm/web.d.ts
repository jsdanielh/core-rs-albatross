...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h965feb42983a4aed: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha2d092c8007518f1: (a: number, b: number) => void;
  readonly closure2655_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2863_externref_shim: (a: number, b: number, c: any, d: any) => void;
